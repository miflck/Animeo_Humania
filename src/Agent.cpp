...
void Agent::setup(){
    ...
    position.set(1920/2,1080/2,0);
    
    
    float theta1 = ofRandom(0, TWO_PI);
    float theta2 = ofRandom(0, TWO_PI);
    
    float radius = ofRandom(1920/2,1080/2);
    
    

    
    ofVec3f p;
    p.set(ofRandom(0,1920),ofRandom(0,1080));
   // p.set(1,0,0);
...
void Agent::update(){
   ...
   //applyForce(repulsion(repulsionTarget));
    ...
    applyForce(rotateAround(ofVec3f(1920/2,1080/2,0)));
...
void Agent::setTarget(ofVec3f t){
    target.set(t);
}
